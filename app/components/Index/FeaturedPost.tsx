          ...
          <div className="column is-4-widescreen is-6-desktop mb-5">
            ...
            <article className="card">
              <div className="post-slider slider-sm">
                <img
                  src="https://demo.themefisher.com/reader-bulma/images/post/post-1.jpg"
            ...
            <article className="card mb-5">
              <div className="card-body is-flex">
                <img
                  ...
                  src="https://demo.themefisher.com/reader-bulma/images/post/post-3.jpg"
                />
                <div className="ml-3">
                  <h4>
                    <a href="post-details.html" className="post-title">
            ...
            <article className="card mb-5">
              <div className="card-body is-flex">
                <img
                  alt={""}
                  className="card-img-sm"
                  src="https://demo.themefisher.com/reader-bulma/images/post/post-2.jpg"
                />
                <div className="ml-3">
                  <h4>
                    <a href="post-details.html" className="post-title">
                      The Design Files - Homes Minimalist
                    </a>
                  </h4>
                  <ul className="card-meta mt-2">
                    <li className="list-inline-item mb-0">
            ...
            <article className="card mb-5">
              <div className="card-body is-flex">
                <img
                  alt={""}
                  className="card-img-sm"
                  src="https://demo.themefisher.com/reader-bulma/images/post/post-4.jpg"
                />
                <div className="ml-3">
                  <h4>
                    <a href="post-details.html" className="post-title">
